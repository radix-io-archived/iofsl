...
namespace iofwd
{
   ...
   {
        RPC_GENPROCESS (IOFSLRPCRenameRequest, (()(from_full_path)) 
                                        ((&)(from_parent_handle))
                                        (()(from_component_name))              
                                        (()(to_full_path))
                                        ((&)(to_parent_handle))
      ...
      size_t IOFSLRPCRenameRequest::rpcEncodedInputDataSize()
      {
          return 0;
      }

      size_t IOFSLRPCRenameRequest::rpcEncodedOutputDataSize()
      {
          return 0;
      }
