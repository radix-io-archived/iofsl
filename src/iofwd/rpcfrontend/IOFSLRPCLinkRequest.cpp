...
namespace iofwd
{
   ...
   {
        RPC_GENPROCESS (IOFSLRPCLinkRequest, (()(from_full_path)) 
                                        ((&)(from_parent_handle))
                                        (()(from_component_name))              
                                        (()(to_full_path))
                                        ((&)(to_parent_handle))
      ...
      size_t IOFSLRPCLinkRequest::rpcEncodedInputDataSize()
      {
          return 0;
      }

      size_t IOFSLRPCLinkRequest::rpcEncodedOutputDataSize()
      {
          return 0;
      }
