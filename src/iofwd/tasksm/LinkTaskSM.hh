...
class LinkTaskSM : public BaseTaskSM, public iofwdutil::InjectPool< LinkTaskSM >
{
    public:
        LinkTaskSM (sm::SMManager & smm, zoidfs::util::ZoidFSAsync * api, Request * request)
            : BaseTaskSM(smm, api), ret_(0), request_(static_cast<LinkRequest &>(*request))
        {
        }
