#ifndef __IOFWD_TASKSM_SYMLINKTASKSM_HH__
#define __IOFWD_TASKSM_SYMLINKTASKSM_HH__
...
class SymLinkTaskSM : public BaseTaskSM, public iofwdutil::InjectPool< SymLinkTaskSM >
{
    public:
        SymLinkTaskSM (sm::SMManager & smm, zoidfs::util::ZoidFSAsync * api, Request * request)
            : BaseTaskSM(smm, api), ret_(0), request_(static_cast<SymLinkRequest &>(*request))
        {
        }
