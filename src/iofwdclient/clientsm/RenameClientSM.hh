#ifndef IOFWDCLIENT_SM_RENAMECLIENTSM
#define IOFWDCLIENT_SM_RENAMECLIENTSM
...
namespace iofwdclient
{
    namespace clientsm
    {
typedef  boost::shared_ptr< iofwdclient::clientsm::RPCCommClientSM<common::RPCRenameRequest, common::RPCRenameResponse> > RPCRename;
typedef encoder::EncoderString<0, ZOIDFS_PATH_MAX> EncoderString;
class RenameClientSM :
    public sm::SimpleSM< iofwdclient::clientsm::RenameClientSM >
{
    public:
        RenameClientSM(sm::SMManager & smm,
                bool poll,
                RPCRename comm, 
            ...
            sm::SimpleSM< iofwdclient::clientsm::RenameClientSM >(smm, poll),
            slots_(*this),
            cb_(cb),
            ret_(ret),
            comm_(comm),
    ...
    protected:
        ...
        sm::SimpleSlots<NUM_BASE_SLOTS,
            iofwdclient::clientsm::RenameClientSM> slots_;
        ...
        common::RPCRenameRequest in_;
        common::RPCRenameResponse out_;
};
