...
int interval_merge_tree_destroy_tree(interval_merge_tree_node_t * node)
{
    if(node && node != &interval_merge_tree_sentinel)
    {
...
static int interval_merge_tree_insert_rules(interval_merge_tree_node_t ** root, interval_merge_tree_node_t * node)
{
...
int interval_merge_tree_insert(interval_merge_tree_node_t ** node, interval_merge_tree_key_t key, interval_merge_tree_node_t ** root)
{
...
static int interval_merge_tree_delete_rules(interval_merge_tree_node_t ** root, interval_merge_tree_node_t * node)
{
...
interval_merge_tree_node_t * interval_merge_tree_find_delete(interval_merge_tree_node_t ** root, size_t k)
{
    ...
    if((!node->left || node->left == &interval_merge_tree_sentinel) || (!node->right || node->right == &interval_merge_tree_sentinel))
    {
        y = node;
    }
    else
...
/* delete a node from the tree */
interval_merge_tree_node_t * interval_merge_tree_delete(interval_merge_tree_node_t ** root, interval_merge_tree_node_t * node)
{
    interval_merge_tree_node_t * x = NULL;
    interval_merge_tree_node_t * y = NULL;
...
/* print the node */
int interval_merge_tree_print(interval_merge_tree_node_t * node, int level, char dir)
{
    if(!node || node == &interval_merge_tree_sentinel)
    {
        return 0;
...
/* print the tree */
int interval_merge_tree_print_tree(interval_merge_tree_node_t * node)
{
...
/* find the node in the tree given a key */
interval_merge_tree_node_t * interval_merge_tree_node_find_rank(interval_merge_tree_node_t * node, size_t k, int op)
{
...
interval_merge_tree_node_t * interval_merge_tree_interval_search(interval_merge_tree_node_t * root, interval_merge_tree_interval_t interval, unsigned int * oc)
{
    ...
    *oc = RB_TREE_INTERVAL_NO_OVERLAP;
    ...
    while(node != &interval_merge_tree_sentinel && ((*oc = interval_merge_tree_interval_overlap(node, interval)) == RB_TREE_INTERVAL_NO_OVERLAP))
    {
        /* go left */
...
static int interval_merge_tree_interval_update_max(interval_merge_tree_node_t * root, interval_merge_tree_node_t * node)
{
...
int interval_merge_tree_merge_intervals(interval_merge_tree_node_t ** root, interval_merge_tree_node_t ** n_node, interval_merge_tree_key_t key)
{
...
interval_merge_tree_node_t * interval_merge_tree_delete_min_node(interval_merge_tree_node_t ** root)
{
