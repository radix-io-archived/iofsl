...
int interval_merge_tree_destroy_entire_key(interval_merge_tree_key_t * key);
...
int interval_merge_tree_insert_interval(interval_merge_tree_node_t ** node, interval_merge_tree_key_t * key, interval_merge_tree_node_t ** root);
