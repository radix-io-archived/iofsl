...
typedef unsigned long (*HashTableHashFunc)(void * userptr, HashTableKey value);
...
typedef int (*HashTableEqualFunc)(void * userptr, HashTableKey value1, HashTableKey value2);
...
typedef void (*HashTableKeyFreeFunc)(void * userptr, HashTableKey value);
...
typedef void (*HashTableValueFreeFunc)(void * userptr, HashTableValue value);
...
/**
 * Set a user pointer associated with the hash table
 */
void * hash_table_get_user (HashTable * hash_table);

/** 
 * Set user pointer associated with the hash table
 */
