...
bool_t xdr_zoidfs_null_param_t(XDR *xdrs, zoidfs_null_param_t *null_param) {
    return(xdr_int(xdrs, null_param));
}
...
bool_t xdr_zoidfs_handle_t(XDR *xdrs, const zoidfs_handle_t *handle) {
    return(xdr_opaque(xdrs, (char *)handle->data, 16));
}
...
bool_t xdr_zoidfs_time_t(XDR *xdrs, zoidfs_time_t *ztime) {
    ...
    ret = xdr_u_longlong_t(xdrs, &ztime->seconds) &&
          xdr_u_int(xdrs, &ztime->useconds);
...
bool_t xdr_zoidfs_attr_t(XDR *xdrs, zoidfs_attr_t *attr) {
    ...
    ret = xdr_zoidfs_attr_type_t(xdrs, &attr->type) &&
          xdr_u_short(xdrs, &attr->mask) &&
          xdr_u_short(xdrs, &attr->mode) &&
          xdr_u_int(xdrs, &attr->nlink) &&
          xdr_u_int(xdrs, &attr->uid) &&
          xdr_u_int(xdrs, &attr->gid) &&
          xdr_u_longlong_t(xdrs, &attr->size) &&
          xdr_u_int(xdrs, &attr->blocksize) &&
          xdr_u_int(xdrs, &attr->fsid) &&
          xdr_u_longlong_t(xdrs, &attr->fileid) &&
...
bool_t xdr_zoidfs_cache_hint_t(XDR *xdrs, zoidfs_cache_hint_t *hint) {
    ...
    ret = xdr_u_longlong_t(xdrs, &hint->size) &&
...
bool_t xdr_zoidfs_sattr_t(XDR *xdrs, zoidfs_sattr_t *attr) {
    ...
    ret = xdr_u_short(xdrs, &attr->mask) &&
          xdr_u_short(xdrs, &attr->mode) &&
          xdr_u_int(xdrs, &attr->uid) &&
          xdr_u_int(xdrs, &attr->gid) &&
          xdr_u_longlong_t(xdrs, &attr->size) &&
