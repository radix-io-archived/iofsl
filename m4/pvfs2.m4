...
then
   ...
   then
     ...
     ZFS_DISPATCHER_CFLAGS="${ZFS_DISPATCHER_CFLAGS} ${PVFS2_CFLAGS}"
     ZFS_DISPATCHER_CPPFLAGS="${ZFS_DISPATCHER_CPPFLAGS} ${PVFS2_CPPFLAGS}"
     ZFS_DISPATCHER_LDFLAGS="${ZFS_DISPATCHER_LDFLAGS} ${PVFS2_LDFLAGS}"
     ZFS_DISPATCHER_LIBS="${ZFS_DISPATCHER_LIBS} ${PVFS2_LIBS}"
